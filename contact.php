					...
					<div class='contact-item'>
						...
						<form method="POST" action="" id="formpage">
							<table id="formtable">
								...
								<tr>
									<td><b>*Full Name:</b></td>
									<td><input type="text" name="citizenName" class='forminput' placeholder="Enter a name"></td>
								</tr>
								<tr>
									<td><b>*Email:</b></td>
									<td><input type="email" name="emailF" class='forminput' placeholder="Enter an email address"></td>
								</tr>
								<tr>
									<td><b>*Subject:</b></td>
