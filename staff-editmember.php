<!DOCTYPE html>
	<html lang="en">
	<head>
		<title>E-Library | Edit Member</title>
		<meta charset="utf-8">
				...
				<main>
					<div class="main-container">
						...
						<div>
							...
							<h2 class='statbox-title-h2'>Edit Member</h2>
							<hr>
							<div class="task-container">
								<?php
									if(isset($_GET['memberID'])&& isset($_GET['role'])){
									$memberID=$_GET['memberID'];
									$staffEmail=$_GET['staffEmail'];
									include 'connection.php';
									include 'member.php';

									$query = dbConn()->prepare('SELECT * FROM member WHERE memberID="'. $memberID .'"');
									$query->execute();
		                    ...
		                    $lastLogin = $member->getlastLogin();
										...
										echo "
											...
											<form method='POST'  enctype='multipart/form-data' action='staff-editmember2.php?staffEmail=".$staffEmail."&role=".$role."&memberID=".$memberID."'>
												...
												<table id='formtable'>
													...
													<tr>
														...
														<td><input type='email'  name='memberEmail' class='forminput' placeholder='Enter an email address' value='$memberEmail' readonly></td>
													</tr>
													<tr>
														<td><b>*Phone:</b></td>
