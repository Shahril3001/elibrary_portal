			...
			<div id="wrapper">
				...
				<main>
					<div class="main-container">
						<div class='greeting'>
							...
							<?php
								if(isset($_GET['memberEmail'])&& isset($_GET['role'])){
									...
									$query1->execute();
									$memberData = $query1->fetch(PDO::FETCH_ASSOC);
									if ($memberData) {
				            $member = new Member(
				                $memberData['memberID'],
		                    ...
		                    $memberName = $member->getMemberName();
												$lastLogin = $member->getLastLogin();
	 											$formattedLastLogin = date('d F Y H:i:s A', strtotime($lastLogin));
		                }

									echo"<h3>WELCOME, ".strtoupper($memberName)."</h3></br>
						...
						<?php
						echo"<a href='member-catalogue.php?memberEmail=".$memberEmail."&role=".$role."'><button class='button' id='statbox-viewAllBtn'><i class='fa fa-eye'></i> View All Catalogue</button></a>";
						?>
						<h2 class='statbox-title-h2'>Recently Added</h2>
						<hr>
						<div class="partner">
							<div class="wrapper">
									<?php
					...
					<div class="partner">
						...
						<div id="slideshow">
						    <div id="slides">
						        ...
						        // Define your hardcoded array here with correct image paths
						        $slideshows = [
						            [
						                'slideshowID' => 1,
