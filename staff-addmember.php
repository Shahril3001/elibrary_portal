<!DOCTYPE html>
	<html lang="en">
	<head>
		<title>E-Library | Add Member</title>
		<meta charset="utf-8">
				...
				<main>
					<div class="main-container">
						...
						<div>
							...
							<h2 class='statbox-title-h2'>Add Member</h2>
							<hr>
							<div class="task-container">
								<?php
										echo "
											<p>Required fields are marked with an asterisk (*).</p>
											<form method='POST' enctype='multipart/form-data' action='staff-addmember2.php?staffEmail=".$staffEmail."&role=".$role."'>
												<table id='formtable'>
													<tr>
