...
if (isset($_POST['Submit'])) {
    ...
    if (empty($memberName) || empty($memberEmail) || empty($memberPhone) || empty($memberDOB) || empty($memberPassword)) {
				...
				echo "<p id='invalid'>Some of fields is empty. You can't proceed.</p>
          ...
          if (in_array($fileimg_extension, $valid_extension)) {
              ...
              if ($member->addMember($memberName, $memberEmail, $memberPhone, $memberDOB, $imageup, $memberAddress, $memberPassword)) {
                    echo "<div class='pos'>";
    								...
    								<p>Click <a href='staff-memberlist.php?staffEmail=".$staffEmail."&role=".$role."'><input id='returnBtn' class='button' type='button' name='return' value='Return'></a> to return.</p>
    								";
    								echo "</div>";
                } else {
                    echo "<div class='pos'>";
